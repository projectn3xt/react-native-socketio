...
This project was forked from Gcabtree' React Native Swift Socket.Io project
[found here](https://github.com/gcrabtree/react-native-socketio)
...
- Run in your project:
```sh
$ npm install https://github.com/projectn3xt/react-native-socketio
```
